...
INSERT INTO public.produto (id, descricao, imagem_url, nome, preco, tempo_preparo_minutos, categoria)
VALUES(4, 'Café quente com uma barra de chocolate mergulhada, derretendo aos poucos.', 'https://i.imgur.com/HtOWCvJ.jpeg', 'Submarino', 13.90, 10, 'bebida-quente')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.produto (id, descricao, imagem_url, nome, preco, tempo_preparo_minutos, categoria)
VALUES(17, 'Clássico salgado com recheio de frango com catupiry, crocante por fora e cremoso por dentro.', 'https://i.imgur.com/qV5uURH.jpeg', 'Coxinha de Frango com catupiry', 15.90, 12, 'lanche')
ON CONFLICT (id) DO NOTHING;
